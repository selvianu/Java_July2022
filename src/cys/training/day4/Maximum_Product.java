...
public class Maximum_Product {
	public static void main(String[] args) {
		...
		System.out.println("Enter " + tam +" numbers");
	...
	private static int getMaxProductAdjacentElements(int[] numbers) {
		...
		// Traverse the array and check if each pair of elements is greater than the
		// previous pair and assign to the variable max
